...
public class AddTeacher extends JFrame implements ActionListener {
    ...
    JLabel labelidno;
    JDateChooser dcdob;
    JComboBox cbdepartment, cbsubject;
    ...
    AddTeacher() {
        ...
        JLabel lblidno = new JLabel("Teacher ID");
        ...
        lbldepartment.setBounds(400, 300, 200, 30);
        ...
        JLabel lblsubject = new JLabel("Class Subject");
        lblsubject.setBounds(50, 350, 200, 30);
