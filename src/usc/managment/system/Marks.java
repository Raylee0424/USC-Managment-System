...
public class Marks extends JFrame implements ActionListener {
    ...
    Marks(String idno) {
        ...
        JLabel heading = new JLabel("University of San Carlos");
        ...
        lblidno.setBounds(60, 100, 500, 20);
        ...
        try {
            ...
            ResultSet rs1 = c.s.executeQuery("select * from subject where idno = '"+idno+"'");
            while(rs1.next()) {
            ...
            ResultSet rs2 = c.s.executeQuery("select * from marks where idno = '"+idno+"'");
            while(rs2.next()) {
